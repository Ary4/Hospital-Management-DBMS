...
<div class="container">
	<form:form method="post" modelAttribute="orders" action="checkout" class="form-inline">
			<br>
			<br>
			<br>
			<br>
			...
			<br>
				<form:input path="address" type="address" class="form-control" placeholder="address" value="temporary address"/>
				<!-- bind to user.name-->
