...
<body>
	...
	<br>
	<br>
	<a href="${next}/additem">Add New Item</a>
	<div class="container">
	...
	<thead>
      <tr>
      	<th>Product Id</th>
        <th>Quantity</th>
        <th>Less than Threshold ?(value)</th>
        <th>Actions</th>
      </tr>
    </thead>
    <tbody>
    ...
    <td>${item.prodname }</td>
    <td>${item.quantity }</td>
    <td>${item.low } (${item.limit})</td>
    <td><a href="${next}/fillitem/${item.prodid}">Fill </a> |
    <a href="${next}/takeitem/${item.prodid}">Take</a></td>
    <td><a href="${next}/itemdetails/${item.prodid}">Details</a></td>
