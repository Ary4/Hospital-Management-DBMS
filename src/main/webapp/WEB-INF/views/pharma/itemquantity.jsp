...
<nav class="navbar navbar-inverse navbar-fixed-top" style="background: #ffffff !important">
	...
	<br>
Item Name :${medid}
Available quantity :${cnt }
<div class="container">
	<form:form method="post" modelattribute ="medicine" action="${next}/itemquantity" class="form-inline">
			<br>
			<br>
			<div class="form-group">
			<label for="">QUANTITY</label>
			<br>
			<input type="number" name="quantity" min="1" max="${cnt}" >
			</div>
			<br>
			<br>
